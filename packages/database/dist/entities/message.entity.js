...
__decorate([
    (0, typeorm_1.ManyToOne)(() => users_entity_1.Users, (user) => user.messages, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => room_entity_1.Rooms, (room) => room.messages, { onDelete: 'CASCADE' }),
