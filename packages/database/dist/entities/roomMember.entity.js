...
exports.RoomMember = exports.RoomMemberRole = void 0;
...
})(RoomMemberRole || (exports.RoomMemberRole = RoomMemberRole = {}));
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => users_entity_1.Users, (user) => user.room_memberships, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => room_entity_1.Rooms, (room) => room.members, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'room_id' }),
    __metadata("design:type", room_entity_1.Rooms)
], RoomMember.prototype, "room", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: RoomMemberRole, default: RoomMemberRole.MEMBER }),
    __metadata("design:type", String)
